...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `videomae` | `strict_bootstrap_ucb_gate` | `low` | 0.52 | 0.52 | 1 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 13.7095 | 0.0000 | 0.5000 |

## Validation

| rank | backend | status | policy | AUROC | recall | F1 | FA/min | FA time ratio | TTFD s | flicker |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | `videomae` | `selected` | `strict_bootstrap_ucb_gate` | 0.5000 | 0.0 | 0.0 | 0.0 | 0.0 | 17.857143 | 0.0 |

## Test

| backend | status | policy | AUROC | recall | F1 | FA/min | FA time ratio | TTFD s | flicker |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `videomae` | `selected` | `strict_bootstrap_ucb_gate` | 0.4201 | 0.0 | 0.0 | 0.0 | 0.0 | 18.292707 | 0.0 |
