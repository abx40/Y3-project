...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `effort_clip_l14` | `strict_bootstrap_ucb_gate` | `high` | 0.51 | 0.51 | 1 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 13.7095 | 0.0000 | 0.5329 |

## Validation

| rank | backend | status | policy | AUROC | recall | F1 | FA/min | FA time ratio | TTFD s | flicker |
| ---: | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | `effort_clip_l14` | `selected` | `strict_bootstrap_ucb_gate` | 0.5329 | 0.0 | 0.0 | 0.0 | 0.0 | 17.857143 | 0.0 |

## Test

| backend | status | policy | AUROC | recall | F1 | FA/min | FA time ratio | TTFD s | flicker |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `effort_clip_l14` | `selected` | `strict_bootstrap_ucb_gate` | 0.6278 | 0.0 | 0.0 | 0.0 | 0.0 | 18.292707 | 0.0 |
